...
{
    //The following classes and methods were generated by user Ivan Stoev (https://stackoverflow.com/users/5202563/ivan-stoev)
    ...
    public static class BinaryTree
    {
        ...
        public static void Print(this BNode root, string textFormat = "0", int spacing = 1, int topMargin = 2,
            int leftMargin = 2)
        {
            if (root == null) return;
